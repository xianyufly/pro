...
import com.sobt.pro.dao.bean.TBootstrapSubjectExample.Criteria;
import com.sobt.pro.dao.bean.TBootstrapSubjectExample.Criterion;
import com.sobt.pro.dao.bean.TBootstrapSubjectExample;
import java.util.List;
import org.apache.ibatis.jdbc.SQL;

public class TBootstrapSubjectSqlProvider {

    public String insertSelective(TBootstrapSubject record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_bootstrap_subject");
    ...
    public String selectByExample(TBootstrapSubjectExample example) {
        SQL sql = new SQL();
    ...
    public String updateByPrimaryKeySelective(TBootstrapSubject record) {
        SQL sql = new SQL();
        sql.UPDATE("t_bootstrap_subject");
    ...
    protected void applyWhere(SQL sql, TBootstrapSubjectExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
